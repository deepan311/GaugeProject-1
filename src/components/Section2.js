...
function Section2() {
  return (
    <div>
      {" "}
      <div className=" grid grid-cols-2 w-full py-10 px-5 lg:px-10 bg-white rounded-b-3xl">
        <div className="col-span-2 lg:col-span-1  lg:px-10  flex flex-col justify-center items-center">
          <div
          ...
          <div className="w-full my-6">
            <h2 className="text-[30px] lg:text-[42px] text-left  font-semibold">
              Take Control
            </h2>
            <h2 className="text-[30px] lg:text-[42px] text-left  font-semibold text-red-500">
          ...
          <h2 className="text-[16px] lg:text-[20px] text-gray-500">
          ...
          <div className="w-full mt-6">
            <div className="flex ">
              <BsFillCheckCircleFill className="text-[39px] lg:text-[30px] text-green-400" />
              <div className="ml-4 ">
                <h3 className=" text-xl lg:text-2xl font-bold text-gray-900">
                  Smart Water Purifier With Self Servicing Capability
                </h3>
                <h3 className=" text-[16px] lg:text-[20px] my-4 text-gray-500">
          ...
          <button className="px-10 my-4  bg-blue-500 hover:bg-blue-700 py-4 rounded-full text-md lg:text-xl text-white">
            Next: Smart Water Conservation
          </button>
        </div>

        <div className="col-span-2 order-first lg:order-last lg:col-span-1 flex gap-10 justify-center items-center flex-col mb-10">
